...
DROP table osm_poi_features_category_piv_distcalc;
CREATE table osm_poi_features_category_piv_distcalc as 
select 
	planungsraum, 
	timeslice,
				...
				from (
					...
					from (
						...
						from osm_poi_features_category osm
							join lor_dist_planungsraum lor on lor.toareaname = osm.planungsraum
