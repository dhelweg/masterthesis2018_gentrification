drop table osm_poi_oa;
create table osm_poi_oa as
select 
  d.planungsraum,
  d.timeslice,
	...
	from osm_poi_features_domain_piv d
left join osm_poi_features_category_piv c
	on d.timeslice = c.timeslice
	and cast(d.planungsraum as int) = cast(c.planungsraum as int)
left join osm_poi_features_type_piv t
