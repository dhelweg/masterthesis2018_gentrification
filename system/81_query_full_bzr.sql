drop table result_full_bzr;
create table result_full_bzr as 
...
t_sonstiges_erholung_stock                              as prev_t_sonstiges_erholung_stock
  ...
  from osm_poi_features_type_piv_bzr
  where timeslice in (201501) 
) stock_t_prev
...
c_sonstiges_tourismus_stock         as prev_c_sonstiges_tourismus_stock         
  ...
  from osm_poi_features_category_piv_bzr
  where timeslice in (201501) 
) stock_c_prev
...
(select 
  ...
  from osm_poi_features_domain_piv_bzr
  where timeslice in (201501) 
) stock_d_prev
